...
public class MyLearnCrawlerApplication {
    ...
    public static void main(String[] args) {
        UrlSearch.initUrl("https://blog.csdn.net/weixin_33788244/article/details/93079933?utm_medium=distribute.pc_relevant.none-task-blog-baidujs_title-0&spm=1001.2101.3001.4242");
        UrlSearch.searchUrl();
